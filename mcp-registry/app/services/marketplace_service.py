...
class MarketplaceSyncService:
    ...
    async def list_servers(
        ...
        # Instance-wide visibility filter: ``conf/server_visibility.json``
        # lets the instance admin hide individual servers from the
        # marketplace catalog globally. Default is visible.
        ...
        # Sort by: official/curated first, then tools count, quality, popularity.
        def sort_key(s):
