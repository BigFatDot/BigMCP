...
/**
 * Button component with BigMCP design system.
 *
 * @example
 * <Button variant="primary">Click me</Button>
 * <Button variant="outline" size="sm" leftIcon={<Icon />}>Small button</Button>
...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      primary:
        'bg-orange text-white hover:bg-orange-600 focus:ring-orange shadow-orange',
      secondary:
        'bg-gray-100 text-gray-900 hover:bg-gray-200 focus:ring-gray-500',
      outline:
        'border-2 border-orange text-orange hover:bg-orange hover:text-white focus:ring-orange',
      ghost:
